// src/lib.rs
/*
 * Core library for DataInterface
 */
...
#[derive(Debug)]
pub struct DataInterfaceProcessor {
    verbose: bool,
    processed_count: usize,
}

impl DataInterfaceProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting DataInterface processing");
    
    let mut processor = DataInterfaceProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = DataInterfaceProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = DataInterfaceProcessor::new(false);
